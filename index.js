...
//   var name123 = productList[0].name;
//   console.log(name123);
// mainCard.innerHTML = name123;

/* <div id="combined-cloth-card">
        <div id="cloth-image">
            <img src="https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/9803279/2019/5/27/6661d579-12ae-456b-b8f2-e78e5256a99c1558948436173-Apple-AirPods-with-Charging-Case-2nd-Gen-White-3831558948435-1.jpg" alt="cloth-image" />
        </div>
        <div id="cloth-card-detail">
            <h3>yhr6tyh5rhy</h3>
            <h4>ygre6hyrdcrh</h4>
            <h5>jnhtfuyh7j</h5>
        </div>
...
var CombinedClothCard = document.createElement("div");
CombinedClothCard.id= "combined-cloth-card";
var clothImage = document.createElement("div");
clothImage.id = "cloth-image";
var imgSource = document.createElement("img");
imgSource.src = productList[i].preview;
clothImage.appendChild(imgSource);
var clothCardDetail = document.createElement("div");
clothCardDetail.id="cloth-card-detail";
...
clothCardDetail.appendChild(heading3);
clothCardDetail.appendChild(heading4);
clothCardDetail.appendChild(heading5);
CombinedClothCard.appendChild(clothImage);
CombinedClothCard.appendChild(clothCardDetail);
clothCard.appendChild(CombinedClothCard);

}
else{
    var accessoriesCard = document.getElementById("accessories-card")
var CombinedAccessoriesCard = document.createElement("div");
CombinedAccessoriesCard.id= "combined-accessories-card";
var accessoriesImage = document.createElement("div");
accessoriesImage.id = "accessories-image";
var imgSource = document.createElement("img");
imgSource.src = productList[i].preview;
accessoriesImage.appendChild(imgSource);
var accessoriesCardDetail = document.createElement("div");
accessoriesCardDetail.id="accessories-card-detail";
var heading3 = document.createElement("h3")
heading3.innerHTML= productList[i].name;
var heading4 = document.createElement("h4")
heading4.innerHTML= productList[i].brand;
var heading5 = document.createElement("h5")
heading5.innerHTML= "Rs " + productList[i].price;
accessoriesCardDetail.appendChild(heading3);
accessoriesCardDetail.appendChild(heading4);
accessoriesCardDetail.appendChild(heading5);
CombinedAccessoriesCard.appendChild(accessoriesImage);
CombinedAccessoriesCard.appendChild(accessoriesCardDetail);
accessoriesCard.appendChild(CombinedAccessoriesCard);
}
